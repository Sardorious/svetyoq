...
- **Yozildi (55):** yangi `tests/test_worked_examples_contract.py` (28 ta
  bazasiz test funksiyasi, ~39 ta ishga tushish).

> **Keyingi run uchun.** ⚠️ **Yigirma oltinchi marta** `ruff check` va
