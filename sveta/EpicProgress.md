...
`ruff` ham, `pytest` ham bitta runda yashil). ⚠️ `ruff format --check` esa
...
## 3. Kontrakt qatlami (40–57 runlar)
...
Yo'l-yo'lakay **to'rtta** haqiqiy defekt topildi (`data_quality` ni ikki modul
